    ...
    <div className="w-full sm:w-1/4 md:w-1/5 min-w-[250px] max-h-screen p-4 bg-gray-50 overflow-y-auto shadow-lg">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <div className="bg-white p-4 shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out">
          ...
          <p className="text-gray-600 text-sm">Abby</p>
          <p className="text-gray-600 text-sm">Email: abigail.smith@email.com</p>
        ...
        <div className="bg-white p-4 shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out">
          ...
          <p className="text-gray-600 text-sm">Ticket Owner: Abby</p>
          <p className="text-gray-600 text-sm">Status: Open</p>
          <p className="text-gray-600 text-sm">Due Date: 30 Mar 10:00 AM</p>
        ...
        <div className="bg-white p-4 shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out">
          ...
          <p className="text-gray-600 text-sm">Layout: Default Layout</p>
        </div>
      </div>
    </div>
  );
